...
/*
	==========================================
	 Creating Custom Post Type Album
	==========================================
*/
function custom_post_type()
{
	$labels = array(
		'name'                => _x('Albums', 'Post Type General Name', 'twentytwentyone'),
		'singular_name'       => _x('Album', 'Post Type Singular Name', 'twentytwentyone'),
		'menu_name'           => __('Albums', 'twentytwentyone'),
		'parent_item_colon'   => __('Parent Album', 'twentytwenty'),
		'all_items'           => __('All Albums', 'twentytwentyone'),
		'view_item'           => __('View Album', 'twentytwentyone'),
		'add_new_item'        => __('Add New Album', 'twentytwentyone'),
		'add_new'             => __('Add New', 'twentytwentyone'),
		'edit_item'           => __('Edit Album', 'twentytwentyone'),
		'update_item'         => __('Update Album', 'twentytwentyone'),
		'search_items'        => __('Search Album', 'twentytwentyone'),
	...
	$args = array(
		...
		'description'         => __('Album news and reviews', 'twentytwentyone'),
		'labels'              => $labels,
		'supports'            => array('title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields',),
		'taxonomies'          => array('id_album', 'id_user_album'),
		'hierarchical'        => false,
		'public'              => true,
		'show_ui'             => true,
		'show_in_menu'        => true,
